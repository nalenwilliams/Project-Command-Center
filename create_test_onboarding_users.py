...
async def create_test_users():
    ...
    print(f"   Login URL: https://wdl-hub.preview.emergentagent.com/auth")
    ...
    print(f"   Onboarding URL: https://wdl-hub.preview.emergentagent.com/vendor-onboarding?code={invitation_code}")
