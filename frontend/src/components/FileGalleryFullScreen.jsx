...
const FileGalleryFullScreen = ({ 
  ...
  const getUserNames = (userIds) => {
    ...
    const userNames = userIdArray.map(userId => {
      ...
      // Fallback to email formatting if it looks like a name
      ...
      // Final fallback to username with proper capitalization
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-8">
            ...
            <div className="space-y-3">
              ...
              {recordType === 'report' && record && (
                <>
                  <div>
                    <p className="font-bold text-left" style={{ color: ELEGANT_GOLD }}>Report Type</p>
                    <p className="text-white mt-1 text-left">{record.report_type || 'N/A'}</p>
                  </div>
                  <div>
                    <p className="font-bold text-left" style={{ color: ELEGANT_GOLD }}>Period</p>
                    <p className="text-white mt-1 text-left">{record.period || 'N/A'}</p>
                  </div>
                  <div>
                    <p className="font-bold text-left" style={{ color: ELEGANT_GOLD }}>Generated By</p>
                    <p className="text-white mt-1 text-left">{record.generated_by || 'N/A'}</p>
                  </div>
                  <div>
                    <p className="font-bold text-left" style={{ color: ELEGANT_GOLD }}>Description</p>
                    <p className="text-white mt-1 text-left">{record.description || 'N/A'}</p>
              ...
              {recordType === 'compliance' && record && (
                <>
                  <div>
                    <p className="font-bold text-left" style={{ color: ELEGANT_GOLD }}>Compliance Type</p>
                    <p className="text-white mt-1 text-left">{record.compliance_type || 'N/A'}</p>
                  </div>
                  <div>
                    <p className="font-bold text-left" style={{ color: ELEGANT_GOLD }}>Requirement</p>
                    <p className="text-white mt-1 text-left">{record.requirement || 'N/A'}</p>
                  </div>
                  <div>
                    <p className="font-bold text-left" style={{ color: ELEGANT_GOLD }}>Status</p>
                    <p className="text-white mt-1 text-left">{record.status ? record.status.toUpperCase() : 'N/A'}</p>
              ...
              {recordType === 'employee' && record && (
                <>
                  ...
                  <div>
                    <p className="font-bold text-left" style={{ color: ELEGANT_GOLD }}>Position</p>
                    <p className="text-white mt-1 text-left">{record.position || 'N/A'}</p>
                  </div>
                  <div>
                    <p className="font-bold text-left" style={{ color: ELEGANT_GOLD }}>Department</p>
                    <p className="text-white mt-1 text-left">{record.department || 'N/A'}</p>
                  </div>
                  <div>
                    <p className="font-bold text-left" style={{ color: ELEGANT_GOLD }}>Hire Date</p>
                    <p className="text-white mt-1 text-left">{record.hire_date ? new Date(record.hire_date).toLocaleDateString() : 'N/A'}</p>
                  </div>
                </>
              )}

              {recordType === 'fleet-inspection' && record && (
                <>
                  <div>
                    <p className="font-bold text-left" style={{ color: ELEGANT_GOLD }}>Vehicle ID</p>
                    <p className="text-white mt-1 text-left">{record.vehicle_id || 'N/A'}</p>
                  </div>
                  <div>
                    <p className="font-bold text-left" style={{ color: ELEGANT_GOLD }}>Inspection Date</p>
                    <p className="text-white mt-1 text-left">{record.inspection_date ? new Date(record.inspection_date).toLocaleDateString() : 'N/A'}</p>
                  </div>
                  <div>
                    <p className="font-bold text-left" style={{ color: ELEGANT_GOLD }}>Inspector</p>
                    <p className="text-white mt-1 text-left">{record.inspector || 'N/A'}</p>
                  </div>
                  <div>
                    <p className="font-bold text-left" style={{ color: ELEGANT_GOLD }}>Status</p>
                    <p className="text-white mt-1 text-left">{record.status ? record.status.toUpperCase() : 'N/A'}</p>
                  ...
                  <div>
                    <p className="font-bold text-left" style={{ color: ELEGANT_GOLD }}>Mileage</p>
                    <p className="text-white mt-1 text-left">{record.mileage || 'N/A'}</p>
                  </div>
                  <div>
                    <p className="font-bold text-left" style={{ color: ELEGANT_GOLD }}>Notes</p>
                    <p className="text-white mt-1 text-left">{record.notes || 'N/A'}</p>
